...
namespace TinyJSON
{
	...
	// License: MIT
	// We stripped out the Write code.
	public sealed class JSON
	{
		...
		#region External resolution interface
		...
		#region Accelerated Pow operations
		...
		#region Default node resolution
