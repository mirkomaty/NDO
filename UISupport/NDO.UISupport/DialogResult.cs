...
{
	/// <summary>
	/// Return Values from the NDO UI Components.
	/// The values are identical to the values defined in Windows Forms.
	/// If an implementation uses Windows Forms, the values can simply be converted.
	/// </summary>
	public enum NdoDialogResult
	{
		/// <summary>
